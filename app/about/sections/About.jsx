...
const About = () => (
  <section className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6">
    <div className="flex flex-col gap-12">
      ...
      <div className="flex flex-col gap-4">
        <h2 className="text-2xl font-bold text-zinc-100">Beyond Coding</h2>
        <p className="text-zinc-400 leading-relaxed text-base lg:text-lg">
        ...
        <div className="mt-2">
          <Link href="/contact" className="text-zinc-400 hover:text-zinc-100 underline decoration-zinc-500 underline-offset-4 transition-colors">
            Get in Touch
          </Link>
        </div>
      </div>
